...
proc helpCommand*() =
  ...
  styledEcho fgMagenta, "  upgrade", fgWhite, "     Upgrade package(s) to latest"
  styledEcho fgMagenta, "  remove", fgWhite, "      Remove package(s)"
  styledEcho fgMagenta, "  deps-graph", fgWhite, "  Show dependency graph"
  styledEcho fgMagenta, "  publish", fgWhite, "     Publish a package"
  styledEcho fgMagenta, "  search", fgWhite, "      Search for packages"
